...
neighbors = server_neighbors.split(',')
database_drivers.add_node_in_cluster(str(server_cluster),str(server_ip))
for neighbor in neighbors:
    database_drivers.add_node_in_cluster(str(server_cluster),str(neighbor))